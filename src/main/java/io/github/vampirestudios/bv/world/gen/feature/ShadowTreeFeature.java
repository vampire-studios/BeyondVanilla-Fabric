...
public class ShadowTreeFeature extends AbstractTreeFeature<DefaultFeatureConfig> {
   ...
   private int makeOrCheckBranch(Set<BlockPos> set_1, ModifiableTestableWorld modifiableTestableWorld_1, BlockPos blockPos_1, BlockPos blockPos_2, boolean boolean_1, BlockBox mutableIntBoundingBox_1) {
      if (!boolean_1 && Objects.equals(blockPos_1, blockPos_2)) {
         ...
         for(int int_2 = 0; int_2 <= int_1; ++int_2) {
            ...
            if (boolean_1) {
               this.setBlockState(set_1, modifiableTestableWorld_1, blockPos_4, LOG.with(LogBlock.AXIS, this.getLogAxis(blockPos_1, blockPos_4)), mutableIntBoundingBox_1);
   ...
   private Direction.Axis getLogAxis(BlockPos blockPos_1, BlockPos blockPos_2) {
      Direction.Axis direction$Axis_1 = Direction.Axis.Y;
      ...
      if (int_3 > 0) {
         if (int_1 == int_3) {
            direction$Axis_1 = Direction.Axis.X;
         } else if (int_2 == int_3) {
            direction$Axis_1 = Direction.Axis.Z;
         }
      }
   ...
   public boolean generate(Set<BlockPos> set_1, ModifiableTestableWorld modifiableTestableWorld_1, Random random_1, BlockPos blockPos_1, BlockBox mutableIntBoundingBox_1) {
      ...
      if (int_1 == -1) {
         ...
         int int_5 = int_1 - 5;
         List<ShadowTreeFeature.BranchPosition> list_1 = Lists.newArrayList();
         list_1.add(new ShadowTreeFeature.BranchPosition(blockPos_1.up(int_5), int_4));
               ...
               for(int int_6 = 0; int_6 < int_3; ++int_6) {
                  ...
                  if (this.makeOrCheckBranch(set_1, modifiableTestableWorld_1, blockPos_2, blockPos_3, false, mutableIntBoundingBox_1) == -1) {
                     ...
                     if (this.makeOrCheckBranch(set_1, modifiableTestableWorld_1, blockPos_4, blockPos_2, false, mutableIntBoundingBox_1) == -1) {
                        list_1.add(new ShadowTreeFeature.BranchPosition(blockPos_2, blockPos_4.getY()));
                     }
                  }
               }
            }
   ...
   protected static boolean isDirtOrGrass(TestableWorld testableWorld_1, BlockPos blockPos_1) {
      return testableWorld_1.testBlockState(blockPos_1, (blockState_1) -> {
         ...
         return block_1 == BVBlocks.SHADOW_GRASS || block_1 == BVBlocks.SHADOW_DIRT;
      });
   }
   ...
   static class BranchPosition extends BlockPos {
      ...
      BranchPosition(BlockPos blockPos_1, int int_1) {

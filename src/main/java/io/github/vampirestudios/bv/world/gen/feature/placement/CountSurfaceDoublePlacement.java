...
public class CountSurfaceDoublePlacement extends Decorator<CountDecoratorConfig> {
    private final PlacementLevel placementLevel;

    public CountSurfaceDoublePlacement(Function<Dynamic<?>, ? extends CountDecoratorConfig> deserialize, PlacementLevel placementLevel) {
        super(deserialize);

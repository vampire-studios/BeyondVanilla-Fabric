...
public class ChunkGeneratorTypeWorkaround implements InvocationHandler {
    ...
    public ShadowChunkGenerator createProxy(World w, BiomeSource biomesource, ChunkGeneratorConfig gensettings) {
        return new ShadowChunkGenerator(w, biomesource, gensettings);
    }

...
public class ChanceSurfacePlacement extends Decorator<ChanceRangeDecoratorConfig> {
    private final PlacementLevel placementLevel;

    public ChanceSurfacePlacement(Function<Dynamic<?>, ? extends ChanceRangeDecoratorConfig> deserialize, PlacementLevel placementLevel) {
        super(deserialize);

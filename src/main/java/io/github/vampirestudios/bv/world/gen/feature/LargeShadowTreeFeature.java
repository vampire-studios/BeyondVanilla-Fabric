...
public class LargeShadowTreeFeature extends AbstractTreeFeature<DefaultFeatureConfig> {
            ...
            for(int int_3 = -int_1; int_3 <= int_1; ++int_3) {
                if (Math.pow((double)Math.abs(int_2) + 0.5D, 2.0D) + Math.pow((double)Math.abs(int_3) + 0.5D, 2.0D) <= (double)(float_1 * float_1)) {
                    ...
                    if (isAirOrLeaves(modifiableTestableWorld_1, blockPos_2)) {
                        this.setBlockState(set_1, modifiableTestableWorld_1, blockPos_2, LEAVES, blockBox_1);
                    }
                }
            }
        }
    ...
    private void makeLeaves(ModifiableTestableWorld modifiableTestableWorld_1, BlockPos blockPos_1, BlockBox blockBox_1, Set<BlockPos> set_1) {
        for(int int_1 = 0; int_1 < 5; ++int_1) {
            this.makeLeafLayer(modifiableTestableWorld_1, blockPos_1.up(int_1), this.getLeafRadiusForLayer(int_1), blockBox_1, set_1);
        }

    }

    private int makeOrCheckBranch(Set<BlockPos> set_1, ModifiableTestableWorld modifiableTestableWorld_1, BlockPos blockPos_1, BlockPos blockPos_2, boolean boolean_1, BlockBox blockBox_1) {
        if (!boolean_1 && Objects.equals(blockPos_1, blockPos_2)) {
            ...
            for(int int_2 = 0; int_2 <= int_1; ++int_2) {
                BlockPos blockPos_4 = blockPos_1.add(0.5F + (float)int_2 * float_1, 0.5F + (float)int_2 * float_2, 0.5F + (float)int_2 * float_3);
                if (boolean_1) {
                    this.setBlockState(set_1, modifiableTestableWorld_1, blockPos_4, LOG.with(LogBlock.AXIS, this.getLogAxis(blockPos_1, blockPos_4)), blockBox_1);
    ...
    private void makeLeaves(ModifiableTestableWorld modifiableTestableWorld_1, int int_1, BlockPos blockPos_1, List<LargeShadowTreeFeature.BranchPosition> list_1, BlockBox blockBox_1, Set<BlockPos> set_1) {
        for (BranchPosition largeOakTreeFeature$BranchPosition_1 : list_1) {
            if (this.isHighEnough(int_1, largeOakTreeFeature$BranchPosition_1.getEndY() - blockPos_1.getY())) {
                this.makeLeaves(modifiableTestableWorld_1, largeOakTreeFeature$BranchPosition_1, blockBox_1, set_1);
            }
        }
    }
    ...
    private void makeTrunk(Set<BlockPos> set_1, ModifiableTestableWorld modifiableTestableWorld_1, BlockPos blockPos_1, int int_1, BlockBox blockBox_1) {
        this.makeOrCheckBranch(set_1, modifiableTestableWorld_1, blockPos_1, blockPos_1.up(int_1), true, blockBox_1);
    }

    private void makeBranches(Set<BlockPos> set_1, ModifiableTestableWorld modifiableTestableWorld_1, int int_1, BlockPos blockPos_1, List<LargeShadowTreeFeature.BranchPosition> list_1, BlockBox blockBox_1) {
        for (BranchPosition largeOakTreeFeature$BranchPosition_1 : list_1) {
            ...
            if (!blockPos_2.equals(largeOakTreeFeature$BranchPosition_1) && this.isHighEnough(int_1, int_2 - blockPos_1.getY())) {
                this.makeOrCheckBranch(set_1, modifiableTestableWorld_1, blockPos_2, largeOakTreeFeature$BranchPosition_1, true, blockBox_1);
            }
        }
    }
    ...
    public boolean generate(Set<BlockPos> set_1, ModifiableTestableWorld modifiableTestableWorld_1, Random random_1, BlockPos blockPos_1, BlockBox blockBox_1) {
        ...
        int int_1 = this.getTreeHeight(set_1, modifiableTestableWorld_1, blockPos_1, 5 + random_2.nextInt(12), blockBox_1);
        if (int_1 == -1) {
            return false;
        } else {
            ...
            int int_5 = int_1 - 5;
            List<LargeShadowTreeFeature.BranchPosition> list_1 = Lists.newArrayList();
            list_1.add(new LargeShadowTreeFeature.BranchPosition(blockPos_1.up(int_5), int_4));
            ...
            for(; int_5 >= 0; --int_5) {
                ...
                if (float_1 >= 0.0F) {
                    for(int int_6 = 0; int_6 < int_3; ++int_6) {
                        ...
                        BlockPos blockPos_2 = blockPos_1.add(double_5, int_5 - 1, double_6);
                        BlockPos blockPos_3 = blockPos_2.up(5);
                        if (this.makeOrCheckBranch(set_1, modifiableTestableWorld_1, blockPos_2, blockPos_3, false, blockBox_1) == -1) {
                            int int_7 = blockPos_1.getX() - blockPos_2.getX();
                            int int_8 = blockPos_1.getZ() - blockPos_2.getZ();
                            double double_7 = (double)blockPos_2.getY() - Math.sqrt(int_7 * int_7 + int_8 * int_8) * 0.381D;
                            int int_9 = double_7 > (double)int_4 ? int_4 : (int)double_7;
                            BlockPos blockPos_4 = new BlockPos(blockPos_1.getX(), int_9, blockPos_1.getZ());
                            if (this.makeOrCheckBranch(set_1, modifiableTestableWorld_1, blockPos_4, blockPos_2, false, blockBox_1) == -1) {
                                list_1.add(new LargeShadowTreeFeature.BranchPosition(blockPos_2, blockPos_4.getY()));
                            }
                        }
                    }
                }
            ...
            this.makeLeaves(modifiableTestableWorld_1, int_1, blockPos_1, list_1, blockBox_1, set_1);
            this.makeTrunk(set_1, modifiableTestableWorld_1, blockPos_1, int_2, blockBox_1);
            this.makeBranches(set_1, modifiableTestableWorld_1, int_1, blockPos_1, list_1, blockBox_1);
            return true;
        }
    }

    private int getTreeHeight(Set<BlockPos> set_1, ModifiableTestableWorld modifiableTestableWorld_1, BlockPos blockPos_1, int int_1, BlockBox blockBox_1) {
        if (!isDirtOrGrass(modifiableTestableWorld_1, blockPos_1.method_10074())) {
            return -1;
        } else {
            int int_2 = this.makeOrCheckBranch(set_1, modifiableTestableWorld_1, blockPos_1, blockPos_1.up(int_1 - 1), false, blockBox_1);
            if (int_2 == -1) {
                return int_1;
            } else {
    ...
    protected static boolean isDirtOrGrass(TestableWorld testableWorld_1, BlockPos blockPos_1) {
        return testableWorld_1.testBlockState(blockPos_1, (blockState_1) -> {
            ...
            return Block.isNaturalDirt(block_1) || block_1 == BVBlocks.SHADOW_GRASS_BLOCK;
        });
    }

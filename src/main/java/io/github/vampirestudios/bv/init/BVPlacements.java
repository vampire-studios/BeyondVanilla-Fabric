...
public class BVPlacements {
    ...
    public static final Decorator<ChanceDecoratorConfig> CHANCE_SURFACE = new ChanceSurfacePlacement(ChanceDecoratorConfig::deserialize, SurfacePlacementLevel.INSTANCE);
    public static final Decorator<ChanceDecoratorConfig> CHANCE_SURFACE_DOUBLE = new ChanceSurfaceDoublePlacement(ChanceDecoratorConfig::deserialize, SurfacePlacementLevel.INSTANCE);
    ...
    public static final Decorator<ChanceDecoratorConfig> CHANCE_UNDERGROUND = new ChanceSurfacePlacement(ChanceDecoratorConfig::deserialize, UndergroundPlacementLevel.INSTANCE);
    public static final Decorator<ChanceDecoratorConfig> CHANCE_UNDERGROUND_DOUBLE = new ChanceSurfaceDoublePlacement(ChanceDecoratorConfig::deserialize, UndergroundPlacementLevel.INSTANCE);
